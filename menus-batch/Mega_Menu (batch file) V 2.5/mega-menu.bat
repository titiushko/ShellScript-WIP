::Code;
	...
	::Main menu code;
		...
		::Main menu display;
			...
			ECHO 5. Settings (FIXED!)
			ECHO 6. Games (3 NEW GAMES!)
...
EXIT /b
		...
		::Game 4 code;
			...
			;
				...
				CLS
				ECHO INSTRUCTIONS:
				ECHO ææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææ
				ECHO.
		...
		::Encryption code;
			...
			::Initial encrption;
				...
				IF %letter% EQU e SET let%num2%=Ñ
				...
				IF %letter% EQU B SET let%num2%=ú
				...
				IF %letter% EQU L SET let%num2%=Ü
				...
				IF %letter% EQU W SET let%num2%=æ
